...
binding_name = "DeepSeek"
binding_folder_name = ""


  
class DeepSeek(LLMBinding):
    def __init__(self, 
                config: LOLLMSConfig, 
        ...
        binding_config = TypedConfig(
            ConfigTemplate([
                ...
                {"name":"deepseek_key","type":"str","value":"","help":"A valid open AI key to generate text using open ai api"},
...
if __name__=="__main__":
    ...
    oai = DeepSeek(config, lollms_paths,lollmsCom=lollms_app)
    oai.install()
    oai.binding_config.deepseek_key = input("Open AI Key:")
